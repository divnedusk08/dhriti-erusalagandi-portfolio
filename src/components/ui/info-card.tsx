...
export default function AnimatedProfileCard() {
  const profile: ProfileCardProps = {
    name: "Dhriti Erusalagandi",
    role: "Aspiring Biomedical Engineer",
    status: "online",
    avatar: "https://picsum.photos/seed/dhriti/400/400",
    tags: ["Innovator", "Leader"],
    isVerified: true,
    followers: 1240,
  }
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center w-full justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div
          className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-600 to-transparent animate-grid-move"
          style={{
            backgroundImage: `
          ...
          {tags.map((tag, i) => (
            <span
              ...
              className={cn(
                ...
                tag === "Premium" || tag === "Innovator" || tag === "Leader"
